	...
	return (
		<section className='sidebar' >
			...
			{props.isAuth && <>
				...
				<Link to='/app' className='sidebar__main sidebar__button'>
			...
			<Link to='/auth' className='sidebar__sth sidebar__button'>
				<span className='sidebar__button-icon'>#</span>Authention
			</Link>
			<Link to='/reg' className='sidebar__sth sidebar__button'>
				<span className='sidebar__button-icon'>#</span>Registration
			</Link>
